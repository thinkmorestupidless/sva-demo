...
lazy val `es-demos` = (project in file("."))
  .aggregate(shoppingcartapp)
  .settings(buildSettings: _*)

lazy val shoppingcartapp = project.settings(commonSettings: _*).settings(sharedSettings: _*).enablePlugins(Cinnamon, SbtReactiveAppPlugin)
...
val scalaVer = "2.12.6"
val scalaParserVer = "1.1.0"
val scalaTestVer = "3.0.5"
val sprayJsonVer = "1.3.4"
